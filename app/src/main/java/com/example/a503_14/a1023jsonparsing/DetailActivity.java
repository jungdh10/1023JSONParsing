package com.example.a503_14.a1023jsonparsing;
...
public class DetailActivity extends AppCompatActivity {
    ...
    Handler handler=new Handler(){
        ...
        public void handleMessage(Message message){
            if(message.what==0){
                ...
                if(bitmap == null){
                    Toast.makeText(DetailActivity.this, "이미지 다운로드 실패", Toast.LENGTH_LONG).show();
                }else{
    ...
    class ThreadEx extends Thread{
        ...
        public void run(){
            ...
            try{
                //다운로드 받는 코드(이번엔 getitem)
                URL url=new URL("http://192.168.0.250:8080/android/getitem?itemid="+itemid);
                //Connection 만들기
            ...
            try{
                ...
                map.put("patronus", item.getString("patronus"));
                map.put("picture", item.getString("picture"));
    ...
    class ImgThread extends Thread{
        ...
        public void run(){
            try{
                //spec:이미지파일의 경로
                InputStream is=new URL("http://192.168.0.250:8080/android/img/"+filename).openStream();
